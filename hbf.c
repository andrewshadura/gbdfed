#ifndef lint
#ifdef __GNUC__
static char rcsid[] __attribute__ ((unused)) = "$Id: hbf.c,v 1.3 2000/03/16 20:08:54 mleisher Exp $";
#else
static char rcsid[] = "$Id: hbf.c,v 1.3 2000/03/16 20:08:54 mleisher Exp $";
#endif
#endif
/*
...
reg	const	char	*sp;
{
	...
	return (*lp == '\0' || isspace((int) *lp)) && *sp == '\0';
}
